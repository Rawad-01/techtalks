...
If the provider blocks automated-browser sign-in, use your ordinary browser: sign in, open Profile at desktop width, keep the private email outside the capture, and save `docs/screenshots/profile.png`. Do not substitute an integration-test profile for real authentication.
